...
class Client
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=Avatar::class, mappedBy="utlisateur", cascade={"persist", "remove"})
     */
    private $avatar;
    ...
    public function setAvatar(?Avatar $avatar): self
    {
        ...
        if ($avatar === null && $this->avatar !== null) {
            $this->avatar->setUtlisateur(null);
        }

        // set the owning side of the relation if necessary
        if ($avatar !== null && $avatar->getUtlisateur() !== $this) {
            $avatar->setUtlisateur($this);
        }
