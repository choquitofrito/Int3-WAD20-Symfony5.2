 ...
 */
final class Version20210310214825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aeroport ADD date_mise_en_service DATE DEFAULT NULL, ADD heure_mise_en_service TIME DEFAULT NULL, ADD description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aeroport DROP date_mise_en_service, DROP heure_mise_en_service, DROP description');
    }
}
